...
3. Pull the two base models (~17 GB total)
...
modelfiles/
  ...
  qwen-coder      # implementation — Qwen2.5-Coder 14B, 5-rule pragmatic-coder system prompt
pi/
  extensions/
...
- `qwen-coder` is the slow one (~10–13 tok/s) — `gemma4-fast` is the daily driver (~27 tok/s)
